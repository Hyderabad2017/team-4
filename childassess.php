...
$sql="insert into  values('{$_POST['sid']}',{$_POST['tid']},'{$_POST['name']}','{$_POST['gender']}','{$_POST['teachername']}','{$_POST['age']}','{$_POST['expectedage']}','{$_POST['languageproblem']}',{$_POST['q1']},{$_POST['q2'],{$_POST['q3']},{$_POST['q4']},{$_POST['q5']},{$_POST['q6']})";
?>
