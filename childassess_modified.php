...
<html>
  ...
  <body>
    ...
    <input type="radio" name="rad4" value="notyet" checked> Not Yet
    <input type="radio" name="rad4" value="withlotshelp"> Does with lots of help
    <input type="radio" name="rad4" value="withsomehelp"> Does with some help
    <input type="radio" name="rad4" value="withlittlehelp"> Does with little help
    <input type="radio" name="rad4" value="withouthelp"> Does independently
    <br><br>
    Understanding and following instructions:<input type="radio" name="rad2" value="notyet" checked> Not Yet
    <input type="radio" name="rad5" value="withlotshelp"> Does with lots of help
    <input type="radio" name="rad5" value="withsomehelp"> Does with some help
    <input type="radio" name="rad5" value="withlittlehelp"> Does with little help
    <input type="radio" name="rad5" value="withouthelp"> Does independently
    <br><br>
